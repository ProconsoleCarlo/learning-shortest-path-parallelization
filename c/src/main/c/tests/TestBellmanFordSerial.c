/*
 * TestBellmanFordSerial.c
 *
 * Created on: 25/dic/2014
 * Author: Carlo Bobba, Eleonora Aiello
 * Description: A test to do the Bellman-Ford serial algorithm
 */


/*
 * Function that execute the Bellman-Ford serial algorithm
 ...
 */
void testBellmanFordSerial(int** graph, int graphWidth, int sourceNode) {
	//TODO
	/*int* distance = dijkstra(graph, graphWidth, 0);
